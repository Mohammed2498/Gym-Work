                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="v-pills-ecommerce" role="tabpanel"
                            ...
                            <ul class="vertical-menu">
                                ...
                                <li>
                                    <a href="javaScript:void();">
                                        <img src="assets/images/svg-icon/backend.svg" class="img-fluid"
                                             alt="backend"><span>Back End</span><i
                                            class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                        ...
                        <div class="tab-pane fade" id="v-pills-uikits" role="tabpanel"
                            ...
                            <ul class="vertical-menu">
                                ...
                                <li>
                                    <a href="javaScript:void();">
                                        <img src="assets/images/svg-icon/basic.svg" class="img-fluid" alt="basic"><span>Basic UI</span><i
                                            class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                ...
                                <li>
                                    <a href="javaScript:void();">
                                        <img src="assets/images/svg-icon/advanced.svg" class="img-fluid" alt="advanced"><span>Advanced UI</span><i
                                            class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                ...
                                <li>
                                    <a href="javaScript:void();">
                                        <img src="assets/images/svg-icon/forms.svg" class="img-fluid" alt="forms"><span>Forms</span><i
                                            class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                ...
                                <li>
                                    <a href="javaScript:void();">
                                        <img src="assets/images/svg-icon/charts.svg" class="img-fluid"
                                ...
                                <li>
                                    <a href="javaScript:void();">
                                        <img src="assets/images/svg-icon/icons.svg" class="img-fluid" alt="icons"><span>Icons</span><i
                                            class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                ...
                                <li>
                                    <a href="javaScript:void();">
                                        <img src="assets/images/svg-icon/maps.svg" class="img-fluid" alt="maps"><span>Maps</span><i
                                            class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                ...
                                <li>
                                    <a href="widgets.html">
                                        <img src="assets/images/svg-icon/widgets.svg" class="img-fluid"
                        ...
                        <div class="tab-pane fade" id="v-pills-pages" role="tabpanel"
                            ...
                            <ul class="vertical-menu">
                                ...
                                <li>
                                    <a href="javaScript:void();">
                                        <img src="assets/images/svg-icon/basic_page.svg" class="img-fluid"
                                             alt="basic_page"><span>Basic</span><i
                                            class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                ...
                                <li>
                                    <a href="javaScript:void();">
                                        <img src="assets/images/svg-icon/authentication.svg" class="img-fluid"
